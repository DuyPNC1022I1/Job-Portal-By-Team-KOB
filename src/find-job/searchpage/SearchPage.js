                    ...
                    <nav className="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
                        ...
                        <div className="collapse navbar-collapse" id="navbarCollapse">
                            <div className="navbar-nav ms-auto p-4 p-lg-0">
                                <div className="navbar-nav ms-auto p-4 p-lg-0">
                                    <Link to={'/home-page'} className="nav-item nav-link active iconNavbar">Home
                                        Page</Link>
                                    ...
                                    <div className={' row-nav'}>
                                        ...
                                        <div className={'sortBy-time'}>
                                            <select id={'optional'} onChange={(event) => sortJob(event)}
                                                    className="btn btn-link" style={{width: "179px"}}>
                                            ...
                                            <Form>
                                                ...
                                                <div style={{fontSize: "2px"}}>
                                                    <button className={'btn btn btn-outline-info abcdef'}
                                                            style={{width: "110px", fontSize: "15px"}} type={"submit"}>
                                                        <i className="fa fa-filter fa-lg"><span
                                                            style={{marginRight: "5px"}}></span>Find </i>
                                                    </button>
                                                    <button className={'btn btn btn-outline-warning abcdef'}
                                                            type={"reset"}
                                                            onClick={resetValue}
                                                            style={{
                                                                marginLeft: 8,
                                                                ...
                                                                width: "110px",
                                                                fontSize: "15px"
                                                            }}><i className="fas fa-eraser fa-lg"><span
                                                        style={{marginRight: "5px"}}></span>Reset </i>
                                                    </button>
                                                </div>
                                                <br/>
